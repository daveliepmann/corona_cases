...
(def death-rates
  ...
  [
   ...
   ["Worldwide"                        ""                  18.2     nil        nil     1350000    2016]
...
(def country--code-name-hm
  (conj
   ...
   c/country-code-worldwide
   c/country-code-others
   ))
...
(defn deaths
  ...
  (let [country-name (get country--code-name-hm country-code)]
    (-> (->> death-rates
